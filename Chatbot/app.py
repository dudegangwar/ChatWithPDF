...
os.environ['OPENAI_API_KEY'] = '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'
...
def main():
    ...
    st.header("Chat With Coal Mining AI")
    user_question = st.text_input("Ask Your Question Related To Mining:")
    if user_question:
